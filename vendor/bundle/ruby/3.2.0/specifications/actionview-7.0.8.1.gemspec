# -*- encoding: utf-8 -*-
# stub: actionview 7.0.8.1 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.metadata = { "bug_tracker_uri" => "https://github.com/rails/rails/issues", "changelog_uri" => "https://github.com/rails/rails/blob/v7.0.8.1/actionview/CHANGELOG.md", "documentation_uri" => "https://api.rubyonrails.org/v7.0.8.1/", "mailing_list_uri" => "https://discuss.rubyonrails.org/c/rubyonrails-talk", "rubygems_mfa_required" => "true", "source_code_uri" => "https://github.com/rails/rails/tree/v7.0.8.1/actionview" } if s.respond_to? :metadata=
  ...
  s.add_development_dependency(%q<actionpack>.freeze, ["= 7.0.8.1".freeze])
  s.add_development_dependency(%q<activemodel>.freeze, ["= 7.0.8.1".freeze])
end
