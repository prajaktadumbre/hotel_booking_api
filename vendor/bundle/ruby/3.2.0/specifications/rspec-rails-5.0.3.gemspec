...
Gem::Specification.new do |s|
  ...
  s.add_runtime_dependency(%q<rspec-core>.freeze, ["~> 3.10".freeze])
  s.add_runtime_dependency(%q<rspec-expectations>.freeze, ["~> 3.10".freeze])
  s.add_runtime_dependency(%q<rspec-mocks>.freeze, ["~> 3.10".freeze])
  s.add_runtime_dependency(%q<rspec-support>.freeze, ["~> 3.10".freeze])
  s.add_development_dependency(%q<ammeter>.freeze, ["~> 1.1.5".freeze])
  s.add_development_dependency(%q<aruba>.freeze, ["~> 0.14.12".freeze])
  s.add_development_dependency(%q<cucumber>.freeze, [">= 3.2".freeze, "!= 4.0.0".freeze, "< 8.0.0".freeze])
end
